...
<?php
    ...
    $sql1="SELECT * from dathang where TrangThai='Đã hoàn thành' order by SoDonDH limit $vtbd,$so_dong_tren_mot_trang";
...
<table width="1350px" class="tb_a1" min-height="300px">
    ...
    <?php
        while($row1=mysqli_fetch_array($result1))
        {
            ...
            $link_xoa="?xoa_hoa_don4=co&id=".$id."&trang=".$_GET['trang'];
